...
4. **Testing** — The exported model was tested in Google Colab using the `rsmodel.py` script, which loads the model, preprocesses a sample image, and runs a prediction. The image used for testing was:

  ![pedestrian crossing sign image](pedestrian_crossing-28288.JPG)
